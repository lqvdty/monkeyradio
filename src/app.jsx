...
class Component extends React.Component {
  ...
  GENRES = [
    ...
    {id:'funk', slug:'house-funk-disco', aliases:['funk-soul-disco','funk-soul-disco-house'], label:'House, Funk & Disco', tags:['funk','soul','r&b','rnb','r and b','disco','nu disco','motown','northern soul','boogie','rare groove','neo soul','soul funk','funk soul','1970s','1980s','70s','80s soul']},
